...
bot.on('guildMemberAdd', member => {
  member.guild.channels.get("465948578880159744").setName(`🌐 Total Membrii: ${member.guild.memberCount}`)

  member.guild.channels.get("464924481651998728").setName(`👤 Newest: ${member.user.username}`)
...
bot.login("NDY1OTg1ODMwMDQxODEyOTky.DiVe5w.IldQmvHuoz9VntwccoyBs7rLlA0");
